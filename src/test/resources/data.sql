...
insert into course_student (course_id, student_id) (select s.student_id, c.course_id
                                                    from student s, course c where s.last_name ='Warton' AND c.course_name = 'Pre-Algebra');
